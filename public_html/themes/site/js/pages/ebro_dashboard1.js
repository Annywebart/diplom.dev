    ...
    social: function() {
        if ($('#flot_social').length) {
            ...
            for (var i = 0; i < data_twitter.length; ++i) {
                data_twitter[i][0] += 60 * 120 * 1000
            }
            ;
            for (var i = 0; i < data_google.length; ++i) {
                data_google[i][0] += 60 * 120 * 1000
            }
            ;
            for (var i = 0; i < data_linkedin.length; ++i) {
                data_linkedin[i][0] += 60 * 120 * 1000
            }
            ;
            for (var i = 0; i < data_facebook.length; ++i) {
                data_facebook[i][0] += 60 * 120 * 1000
            }
            ;
