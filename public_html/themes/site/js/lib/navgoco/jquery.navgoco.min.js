...
!function(a) {
    ...
    b.prototype = {init: function() {
            ...
            var c = b.$el.find("li:has(ul) > a");
            b.options.caret && c.append(b.options.caret), c.on("click", function(c) {
                c.stopPropagation(), c.preventDefault();
                var d = a(this).next(), e = d.is(":visible");
                b._toggle(d, !e), b._save()
            })
    ...
    var c = null;
    a.fn.navgoco.defaults = {caret: '<span class="caret"></span>', accordion: !1, openClass: "open", save: !0, cookie: {name: "navgoco", expires: !1, path: "/"}, slide: {duration: 400, easing: "swing"}}
}(jQuery);