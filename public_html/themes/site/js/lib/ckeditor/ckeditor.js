        ...
        (function() {
            ...
            (function() {
                ...
                CKEDITOR.tools = {arrayCompare: function(a, e) {
                        ...
                        if (typeof (d = arguments[b - 1]) == "boolean")
                            b--;
            ...
            CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {appendTo: function(b, c) {
                    ...
                    var a = this.$.cloneNode(b), e = function(a) {
                        ...
                        if (a.nodeType == CKEDITOR.NODE_ELEMENT) {
                            ...
                            if (b)
                                for (var a = a.childNodes, h = 0; h < a.length; h++)
                                    e(a[h])
                        }
                    };
                    e(a);
            ...
            (function() {
                function b(a) {
                    for (var b = 0, d = 0, h = c[a].length; d < h; d++)
                    ...
                    hasAttributes: CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) ? function() {
                        ...
                        function a(a, b, c) {
                            if (b && b.type == CKEDITOR.NODE_ELEMENT) {
                                ...
                                if (a.isIdentical(b)) {
                                    for (var j = c ? a.getLast() : a.getFirst(); f.length; )
                                        f.shift().move(a, !c);
                                    b.moveChildren(a, !c);
                                    b.remove();
                        ...
                        if (i < 0 || f > 0)
                            l(0, b === true ? i : b === false ? f : i < 0 ? i : f);
                        if (c && (j < 0 || h > 0))
                            l(j < 0 ? j : h, 0)
            ...
            (function() {
                    ...
                    if (this.current)
                        ...
                        if (a)
                            ...
                            if (d.type == CKEDITOR.NODE_ELEMENT && !(d = d.getChild(o)))
                                d = k(n, true) === false ? null : n.getNextSourceNode(true, p, k)
                        }
                        d && k(d) === false && (d = null)
                    }
                    for (; d && !this._.end; ) {
                ...
                CKEDITOR.dom.element.prototype.getBogus = function() {
                    ...
                    while (h(a) || d(a) || a.type == CKEDITOR.NODE_ELEMENT && a.getName()in CKEDITOR.dtd.$inline && !(a.getName()in CKEDITOR.dtd.$empty));
                        ...
                        switch (a) {
                            ...
                            case CKEDITOR.ENLARGE_ELEMENT:
                                ...
                                for (; f || m; ) {
                                    if (f && !m) {
                                        !i && f.equals(d) && (i = true);
                                        if (c ? f.isBlockBoundary() : !g.contains(f))
                                            break;
                                    ...
                                    for (; m; ) {
                                        r = false;
                                        if (m.type == CKEDITOR.NODE_COMMENT)
                                            m = m.getPrevious();
                                        else {
                ...
                b.prototype = {getNextParagraph: function(b) {
                        ...
                        if (!d) {
                            ...
                            if (!d && k && !this.enforceRealBlocks && g[k.getName()] && i.checkStartOfBlock() && i.checkEndOfBlock() && !k.equals(i.root))
                                ...
                                this._.nextNode = d.equals(n) ? null : c(i.getBoundaryNodes().endNode, 1, n)
                        }
                        if (o)
                        ...
                        if (q)
                            (i = d.getLast()) && i.type == CKEDITOR.NODE_ELEMENT && i.getName() == "br" && (CKEDITOR.env.ie || i.getPrevious(e) || i.getNext(e)) && i.remove();
                        if (!this._.nextNode)
                            this._.nextNode = l ||
            ...
            (function() {
                ...
                function e(a) {
                    ...
                    return a._.filterFunction = function(g, f, e, h, k, m, t) {
                        ...
                        if (f) {
                            ...
                            if (e) {
                                o = 0;
                                for (v = e.length; o < v; ++o)
                                    b(e[o], g, f, true, m)
                            }
                            if (j) {
                                o = 0;
                                for (v = j.length; o < v; ++o)
                                    b(j[o], g, f, false, m)
                            }
                            if (!f.valid) {
                                h.push(g);
                ...
                CKEDITOR.filter.prototype = {allow: function(b,
                        ...
                        d.length && (m = true);
                        for (var o, t, a = [], c = ["p", "br", "div"][this.enterMode - 1]; o = d.pop(); )
            ...
            CKEDITOR.resourceManager.prototype = {add: function(b, c) {
                    ...
                    CKEDITOR.scriptLoader.load(h, function(b,
                            d) {
                        if (d.length)
                            throw'[CKEDITOR.resourceManager.load] Resource name "' + f[d[0]].join(",") + '" was not found at "' + d[0] + '".';
                    ...
                    var h = {}, f = function(a) {
                        b.call(this, a, function(a) {
                            ...
                            for (j in a) {
                                ...
                                if (!c[j]) {
                                    if (o.icons)
                                        for (var k = o.icons.split(","), g = k.length; g--; )
                                            CKEDITOR.skin.addIcon(k[g], o.path + "icons/" + (CKEDITOR.env.hidpi && o.hidpi ? "hidpi/" : "") + k[g] + ".png");
                                    c[j] = 1
                                }
                                if (q) {
                                    q.split && (q = q.split(","));
            ...
            (function() {
                ...
                function n(a) {
                    ...
                    CKEDITOR.plugins.load(c.split(","), function(c) {
                        ...
                        for (var k in c) {
                            ...
                            if (m && !a.lang[k]) {
                                m.split && (m = m.split(","));
                                if (CKEDITOR.tools.indexOf(m, a.langCode) >= 0)
                                    i = a.langCode;
                                else {
                                ...
                                if (!o.langEntries ||
                                        !o.langEntries[i])
                                    f.push(CKEDITOR.getUrl(o.path + "lang/" + i + ".js"));
                                else {
                ...
                CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {addCommand: function(a, b) {
                        ...
                        var b = this._.data;
                        if (typeof b != "string")
                            b = (b = this.element) && this.elementMode == CKEDITOR.ELEMENT_MODE_REPLACE ? b.is("textarea") ? b.getValue() :
                                    b.getHtml() : "";
                        b = {dataValue: b};
                                ...
                                for (; ; ) {
                                    ...
                                    if (!g.isUnknown && !u.isUnknown && !h[d])
                                        if (u.isOptionalClose)
                                            ...
                                            u = f
                                        } else if (d in CKEDITOR.dtd.$listItem && !q(d, f))
            ...
            (function() {
                ...
                function d(a) {
                    for (var b =
                        ...
                        if (b)
                            var d = a.type, e = a.name;
                        var n = this[c].apply(window, arguments);
                        if (n === false)
                            return n;
                        if (b) {
                            if (n && (n.name != e || n.type != d))
                                return n
            ...
            (function() {
                function b(b, c) {
                        ...
                        return function(d) {
                            if (d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                                ...
                                if (f = CKEDITOR.env.opera && !b || (typeof c == "function" ? c(d) !== false : c))
                                    if (!m && CKEDITOR.env.ie && d.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT)
                                        f = false;
                                    else if (!m && CKEDITOR.env.ie && (document.documentMode > 7 || d.name in CKEDITOR.dtd.tr || d.name in CKEDITOR.dtd.$listItem))
                                        f = false;
                                    else {
                                        f = a(d);
                    ...
                    function o(a, b) {
                        if ((!m || !CKEDITOR.env.ie) && a.type == CKEDITOR.NODE_ELEMENT && a.name == "br" && !a.attributes["data-cke-eol"])
                            return true;
                        var c;
                        if (a.type ==
                            ...
                            if (CKEDITOR.env.ie && m && (!b || a.parent.name in t))
                                return true;
                            if (!m)
                    ...
                    for (q in t)
                        "#"in r[q] || delete t[q];
                    for (q in t)
                        p.elements[q] = k(m, b.config.fillEmptyBlocks !== false);
                    p.root = k(m);
                ...
                var E = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", r = CKEDITOR.dtd, x = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], z = CKEDITOR.tools.extend({}, r.$blockLimit, r.$block), s = {elements: {}, attributeNames: [[/^on/, "data-cke-pa-on"]]}, C = {elementNames: [[/^cke:/, ""], [/^\?xml:namespace$/, ""]], attributeNames: [[/^data-cke-(saved|pa)-/, ""], [/^data-cke-.*/, ""], ["hidefocus",
                            ""]], elements: {$: function(a) {
                            var b = a.attributes;
                            if (b) {
                                if (b["data-cke-temp"])
                    ...
                    $: function(a, b) {
                        ...
                        this.setup()
                            ...
                            if (!b) {
                                var e = /\n{2}/g;
                                if (e.test(a))
                                    var f = "<" + c + ">", i = "</" + c + ">", a = f + a.replace(e, function() {
                                    return i + f
                                }) + i
                            }
                            a = a.replace(/\n/g, "<br>");
                            ...
                            for (var c = this.editor, d = c.config.enterMode,
                                ...
                                if (!m.checkReadOnly()) {
                                    ...
                                    var x, z;
                                    if (j)
                                        for (; (x = m.getCommonAncestor(0, 1)) && (z = CKEDITOR.dtd[x.getName()]) && (!z || !z[i]); )
                                            if (x.getName()in CKEDITOR.dtd.span)
                                                ...
                                                m.splitBlock(d == CKEDITOR.ENTER_DIV ? "div" : "p", c.editable());
                                    m.insertNode(n);
                                    l ||
                                            (l = n)
                                }
                            ...
                            if (l) {
                                ...
                                if (j)
                                    if ((b = l.getNext(a)) && b.type == CKEDITOR.NODE_ELEMENT && b.is(CKEDITOR.dtd.$block))
                                        b.getDtd()["#"] ? m.moveToElementEditStart(b) : m.moveToElementEditEnd(l);
                ...
                var n = function() {
                    ...
                    return function(m, l, z) {
                        ...
                        if (!C.checkReadOnly()) {
                            ...
                            for (t = w.startNode; (t = t.getParent()) && g(t); )
                                y.push(t);
                            s.moveToBookmark(w);
                            if (w = z) {
                                w = l.range;
            ...
            (function() {
                ...
                CKEDITOR.on("instanceCreated", function(a) {
                    ...
                    e.on("contentDom", function() {
                        ...
                        if (i ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera) {
                            ...
                            g.attachListener(CKEDITOR.env.ie ? g : a.getDocumentElement(), "mouseup", c, e);
                ...
                CKEDITOR.dom.selection.prototype = {getNative: function() {
                        ...
                        if (!c || !c.rangeCount)
                            ...
                            if (d == c.endContainer &&
                                    d.nodeType == 1 && c.endOffset - c.startOffset == 1 && q[d.childNodes[c.startOffset].nodeName.toLowerCase()])
                                b = CKEDITOR.SELECTION_ELEMENT
                        }
                        return a.type = b
                    }, getRanges: function() {
                        var a = o ? function() {
                            ...
                            var b = function(b, c) {
                                ...
                                e = k.text.replace(/(\r\n|\r)/g, "\n").length;
                                if (!e)
                                    return{container: d, offset: a(h) + (t > 0 ? 0 : 1)};
                                for (; e > 0; )
                                    try {
                        ...
                        var b = this, c = CKEDITOR.tools.tryThese(function() {
                            return b.getNative().createRange().item(0)
                                ...
                                function() {
                                    for (var a = b.getRanges()[0], c, d, e = 2; e && (!(c = a.getEnclosedNode()) || !(c.type == CKEDITOR.NODE_ELEMENT && q[c.getName()] && (d = c))); e--)
                        ...
                        if (a.length)
                            if (this.isLocked) {
                                ...
                                if (o) {
                                    ...
                                    if (n && n.type == CKEDITOR.NODE_ELEMENT && n.getName()in q && (!n.is("a") || !n.getText()))
                                        try {
            ...
            (function() {
                                ...
                                for (var g = p(this, c), m = g.hasAttributes(), u = o.getCommonAncestor(), r = {}, s = {}, v = {}, z = {}, y, A, E; g && u; ) {
                                    if (u.getName() == d) {
                                        for (y in e.attributes)
                                            if (!z[y] && (E = u.getAttribute(A)))
                                                g.getAttribute(y) == E ? s[y] = 1 : z[y] = 1;
                                        for (A in e.styles)
                                            if (!v[A] && (E = u.getStyle(A)))
                                                g.getStyle(A) == E ? r[A] = 1 : v[A] = 1
                                    }
                                    u = u.getParent()
                                }
                                for (y in s)
                ...
                function q(a) {
                    for (var b = m(this), c = a.getElementsByTag(this.element), d = c.count(); --d >= 0; )
