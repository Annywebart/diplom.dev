...
!function(r) {
    ...
    var t = function(r, t, e, n) {
        ...
        var i = o.getModuleCount(), a = o.getModuleCount() + 2 * n, u = function(r, t) {
            return r -= n, t -= n, 0 > r || r >= i || 0 > t || t >= i ? !1 : o.isDark(r, t)
        }, f = function(r, t, e, n) {
            var o = this.isDark, i = 1 / a;
            this.isDark = function(a, u) {
                var f = u * i, l = a * i, c = f + i, g = l + i;
    ...
    }(), n = "[object Opera]" !== Object.prototype.toString.call(window.opera), o = function(r, e, n, o, i) {
        ...
        var o = n.size, i = "bold " + n.mSize * o + "px " + n.fontname, a = r("<canvas/>")[0].getContext("2d");
        a.font = i;
        var u = a.measureText(n.label).width, f = n.mSize, l = u / o, c = (1 - l) * n.mPosX, g = (1 - f) * n.mPosY, s = c + l, h = g + f, v = .01;
        ...
        var n = e.size, o = e.image.naturalWidth || 1, i = e.image.naturalHeight || 1, a = e.mSize, u = a * o / i, f = (1 - u) * e.mPosX, l = (1 - a) * e.mPosY, c = f + u, g = l + a, s = .01;
        ...
        var f = r.isDark, g = n + i, s = o + i, h = e.radius * i, v = a - 1, d = a + 1, w = u - 1, m = u + 1, T = f(a, u), y = f(v, w), p = f(v, u), B = f(v, m), E = f(a, m), k = f(d, m), A = f(d, u), M = f(d, w), D = f(a, w);
        T ? l(t, n, o, g, s, h, !p && !D, !p && !E, !A && !E, !A && !D) : c(t, n, o, g, s, h, p && D && y, p && E && B, A && E && k, A && D && M)
    }, s = function(t, e, o) {
        var i, a, u = t.moduleCount, l = o.size / u, c = f;
        for (n && o.radius > 0 && o.radius <= .5 && (c = g), e.beginPath(), i = 0; u > i; i += 1)
            for (a = 0; u > a; a += 1) {
                var s = o.left + a * l, h = o.top + i * l, v = l;
                c(t, e, o, s, h, v, i, a)
            }
        if (r(o.fill).is("img")) {
            ...
            e.fillStyle = o.fill, e.fill()
    }, h = function(t, e) {
        var n = o(e.text, e.ecLevel, e.minVersion, e.maxVersion, e.quiet);
        if (!n)
            return null;
        var i = r(t).data("qrcode", n), a = i[0].getContext("2d");
        ...
        if (!e)
            return null;
        var n, i, a = t.size, u = t.background, f = Math.floor, l = e.moduleCount, c = f(a / l), g = f(.5 * (a - c * l)), s = {position: "relative", left: 0, top: 0, padding: 0, margin: 0, width: a, height: a}, h = {position: "absolute", padding: 0, margin: 0, width: c, height: c, "background-color": t.fill}, v = r("<div/>").data("qrcode", e).css(s);
        for (u && v.css("background-color", u), n = 0; l > n; n += 1)
            for (i = 0; l > i; i += 1)
                e.isDark(n, i) && r("<div/>").css(h).css({left: g + i * c, top: g + n * c}).appendTo(v);
        return v
    }, m = function(r) {
    ...
    var y = function() {
            ...
            return o.get = function(r) {
                ...
                for (var e = new Array(o.getLength() + t.getLength() - 1), n = 0; n < o.getLength(); n += 1)
                    for (var i = 0; i < t.getLength(); i += 1)
                        e[n + i] ^= a.gexp(a.glog(o.get(n)) + a.glog(t.get(i)));
                return r(e, 0)
            }, o.mod = function(t) {
                if (o.getLength() - t.getLength() < 0)
                    return o;
                for (var e = a.glog(o.get(0)) - a.glog(t.get(0)), n = new Array(o.getLength()), i = 0; i < o.getLength(); i += 1)
                    n[i] = o.get(i);
                for (var i = 0; i < t.getLength(); i += 1)
        ...
        var t = function(t, e) {
            var o = 236, a = 17, c = t, g = n[e], s = null, h = 0, d = null, w = new Array, m = {}, T = function(r, t) {
                ...
                for (var e = -1; 7 >= e; e += 1)
                    if (!(-1 >= r + e || r + e >= h))
                        for (var n = -1; 7 >= n; n += 1)
                            -1 >= t + n || t + n >= h || (s[r + e][t + n] = e >= 0 && 6 >= e && (0 == n || 6 == n) || n >= 0 && 6 >= n && (0 == e || 6 == e) || e >= 2 && 4 >= e && n >= 2 && 4 >= n ? !0 : !1)
            }, p = function() {
                ...
                for (var r = 8; h - 8 > r; r += 1)
                    null == s[r][6] && (s[r][6] = 0 == r % 2);
                for (var t = 8; h - 8 > t; t += 1)
                    null == s[6][t] && (s[6][t] = 0 == t % 2)
            }, E = function() {
                for (var r = i.getPatternPosition(c), t = 0; t < r.length; t += 1)
                    for (var e = 0; e < r.length; e += 1) {
                        ...
                        if (null == s[n][o])
                            for (var a = -2; 2 >= a; a += 1)
                                for (var u = -2; 2 >= u; u += 1)
                                    s[n + a][o + u] = -2 == a || 2 == a || -2 == u || 2 == u || 0 == a && 0 == u ? !0 : !1
                    }
            }, k = function(r) {
                ...
                for (var n = 0, o = 0, a = 0, u = new Array(e.length), f = new Array(e.length), l = 0; l < e.length; l += 1) {
                    var c = e[l].dataCount, g = e[l].totalCount - c;
                    o = Math.max(o, c), a = Math.max(a, g), u[l] = new Array(c);
                    for (var s = 0; s < u[l].length; s += 1)
                        u[l][s] = 255 & t.getBuffer()[s + n];
                    n += c;
                    var h = i.getErrorCorrectPolynomial(g), v = r(u[l], h.getLength() - 1), d = v.mod(h);
                ...
                for (var T = new Array(m), y = 0, s = 0; o > s; s += 1)
                    for (var l = 0; l < e.length; l += 1)
                        s < u[l].length && (T[y] = u[l][s], y += 1);
                for (var s = 0; a > s; s += 1)
                    for (var l = 0; l < e.length; l += 1)
                        s < f[l].length && (T[y] = f[l][s], y += 1);
                return T
            }, C = function(r, t, e) {
                ...
                for (var s = 0, c = 0; c < n.length; c += 1)
                    s += n[c].dataCount;
                if (l.getLengthInBits() > 8 * s)
                    throw new Error("code length overflow. (" + l.getLengthInBits() + ">" + 8 * s + ")");
                for (l.getLengthInBits() + 4 <= 8 * s && l.put(0, 4); 0 != l.getLengthInBits() % 8; )
                    l.putBit(!1);
                for (; ; ) {
                    if (l.getLengthInBits() >= 8 * s)
                        break;
                    if (l.put(o, 8), l.getLengthInBits() >= 8 * s)
                        break;
                    l.put(a, 8)
                }
                return D(l, n)
        ...
        t.stringToBytes = function(r) {
            ...
            var e = function() {
                for (var e = s(r), n = function() {
                    ...
                    if (-1 == a)
                        break;
                    var u = n(), f = n(), l = n(), c = String.fromCharCode(a << 8 | u), g = f << 8 | l;
                    i[c] = g, o += 1
                }
                if (o != t)
                    throw new Error(o + " != " + t);
        ...
        var e = {MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8}, n = {L: 1, M: 0, Q: 3, H: 2}, o = {PATTERN000: 0, PATTERN001: 1, PATTERN010: 2, PATTERN011: 3, PATTERN100: 4, PATTERN101: 5, PATTERN110: 6, PATTERN111: 7}, i = function() {
            var t = [[], [6, 18], [6, 22], [6, 26], [6, 30], [6, 34], [6, 22, 38], [6, 24, 42], [6, 26, 46], [6, 28, 50], [6, 30, 54], [6, 32, 58], [6, 34, 62], [6, 26, 46, 66], [6, 26, 48, 70], [6, 26, 50, 74], [6, 30, 54, 78], [6, 30, 56, 82], [6, 30, 58, 86], [6, 34, 62, 90], [6, 28, 50, 72, 94], [6, 26, 50, 74, 98], [6, 30, 54, 78, 102], [6, 28, 54, 80, 106], [6, 32, 58, 84, 110], [6, 30, 58, 86, 114], [6, 34, 62, 90, 118], [6, 26, 50, 74, 98, 122], [6, 30, 54, 78, 102, 126], [6, 26, 52, 78, 104, 130], [6, 30, 56, 82, 108, 134], [6, 34, 60, 86, 112, 138], [6, 30, 58, 86, 114, 142], [6, 34, 62, 90, 118, 146], [6, 30, 54, 78, 102, 126, 150], [6, 24, 50, 76, 102, 128, 154], [6, 28, 54, 80, 106, 132, 158], [6, 32, 58, 84, 110, 136, 162], [6, 26, 54, 82, 110, 138, 166], [6, 30, 58, 86, 114, 142, 170]], n = 1335, i = 7973, u = 21522, f = {}, l = function(r) {
                for (var t = 0; 0 != r; )
                    t += 1, r >>>= 1;
                return t
            };
            return f.getBCHTypeInfo = function(r) {
                for (var t = r << 10; l(t) - l(n) >= 0; )
                    t ^= n << l(t) - l(n);
                return(r << 10 | t) ^ u
            }, f.getBCHTypeNumber = function(r) {
                for (var t = r << 12; l(t) - l(i) >= 0; )
                    t ^= i << l(t) - l(i);
                return r << 12 | t
            ...
            return e.getRSBlocks = function(r, e) {
                ...
                for (var i = n.length / 3, a = new Array, u = 0; i > u; u += 1)
                    for (var f = n[3 * u + 0], l = n[3 * u + 1], c = n[3 * u + 2], g = 0; f > g; g += 1)
                        a.push(t(l, c));
                return a
            }, e
        }(), f = function() {
            ...
            var u = c();
            o.write(u);
            for (var f = g(), l = u.toByteArray(), s = 0; s < l.length; s += 1)
                f.writeByte(l[s]);
            f.flush();
            var v = "";
