...
!function(e) {
    var m = function(a, b) {
        ...
        if ((this.component = this.element.is(".date") ? this.element.find(".add-on") : !1) && 0 === this.component.length)
            this.component = !1;
        if (this.isInput)
            this.element.on({focus: e.proxy(this.show, this), blur: e.proxy(this._hide, this), keyup: e.proxy(this.update, this), keydown: e.proxy(this.keydown, this)});
        else if (this.component)
            this.component.on("click", e.proxy(this.show, this)), a = this.element.find("input"), a.on({blur: e.proxy(this._hide, this)});
        else
    ...
    m.prototype = {constructor: m, show: function(a) {
            ...
            for (var a = this.weekStart, b = "<tr>"; a < this.weekStart + 7; )
                b += '<th class="dow">' + l[this.language].daysMin[a++ % 7] + "</th>";
            ...
            for (var k; d.valueOf() < n; ) {
                ...
                k = "";
                if (d.getFullYear() < b || d.getFullYear() == b && d.getMonth() < c)
                    k += " old";
                else if (d.getFullYear() > b || d.getFullYear() == b && d.getMonth() > c)
                    k += " new";
                d.valueOf() == h && (k += " active");
                if (d.valueOf() < this.startDate || d.valueOf() > this.endDate)
                    k += " disabled";
            ...
            b -= 1;
            for (i = - 1; 11 > i; i++)
                html += '<span class="year' + (-1 == i || 10 == i ? " old" : "") + (c == b ? " active" : "") + (b < a || b > e ? " disabled" : "") + '">' + b + "</span>", b += 1;
            f.html(html)
    ...
    var l = e.fn.datepicker.dates = {en: {days: "Sunday Monday Tuesday Wednesday Thursday Friday Saturday Sunday".split(" "), daysShort: "Sun Mon Tue Wed Thu Fri Sat Sun".split(" "), daysMin: "Su Mo Tu We Th Fr Sa Su".split(" "), months: "January February March April May June July August September October November December".split(" "), monthsShort: "Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ")}}, g = {modes: [{clsName: "days", navFnc: "Month", navStep: 1}, {clsName: "months", navFnc: "FullYear", navStep: 1}, {clsName: "years", navFnc: "FullYear", navStep: 10}], isLeapYear: function(a) {
            ...
            if (/^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(a)) {
                for (var f = /([-+]\d+)([dmwy])/, j = a.match(/([-+]\d+)([dmwy])/g), i, h, a = new Date, d = 0; d < j.length; d++)
                    switch (i = f.exec(j[d]), h = parseInt(i[1]), i[2]) {
                        case "d":
            ...
            c.dd = (10 > c.d ? "0" : "") + c.d;
            c.mm = (10 > c.m ? "0" : "") + c.m;
            for (var a = [], f = e.extend([], b.separators), g = 0, i = b.parts.length; g < i; g++)
                f.length && a.push(f.shift()), a.push(c[b.parts[g]]);
            return a.join("")
