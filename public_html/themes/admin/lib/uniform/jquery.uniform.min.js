(function(d, i) {
    ...
    d.fn.uniform = function(b) {
        ...
        function o(a) {
            var c = d("<div />"), e = d("<span>" + b.fileDefaultText + "</span>"), f = d("<span>" + b.fileBtnText + "</span>");
            "none" == a.css("display") && b.autoHide && c.hide();
        ...
        var b = d.extend({}, d.uniform.options, b), p = this;
        ...
        d.uniform.noSelect = function(a) {
            ...
            d(a).each(function() {
                ...
                d(this).mousedown(b).css({MozUserSelect: "none"})
            })
        };
        d.uniform.update = function(a) {
            ...
            a.each(function() {
                ...
                if (a.data("uniformed"))
                    if (a.is("select")) {
                        var e = a.siblings("span"), f = a.parent("div");
