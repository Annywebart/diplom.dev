...
<div class="row-fluid">
    <div class="span12">
        <ul class="dshb_icoNav tac">
            <li><a href="<?php echo Yii::app()->createAbsoluteUrl('admin/facultets/admin');?>" style="background-image: url(<?php echo Yii::app()->params['styleAdmin']; ?>/img/gCons/bookmark.png)">Факультеты</a></li>
