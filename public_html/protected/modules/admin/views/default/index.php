...
<div class="row-fluid">
    <div class="span12">
        <ul class="dshb_icoNav tac">
            <li><a href="<?php echo Yii::app()->createAbsoluteUrl('admin/facultets/admin'); ?>" target="_self" style="background-image: url(<?php echo Yii::app()->params['styleAdmin']; ?>/img/gCons/bookmark.png)">Факультеты</a></li>
            <li><a href="<?php echo Yii::app()->createAbsoluteUrl('admin/facultets/admin'); ?>" target="_self" style="background-image: url(<?php echo Yii::app()->params['styleAdmin']; ?>/img/gCons/bookmark.png)">Факультеты</a></li>
            <li><a href="javascript:void(0)" style="background-image: url(<?php echo Yii::app()->params['styleAdmin']; ?>/img/gCons/multi-agents.png)"><span class="label label-info">+10</span> Users</a></li>
            <li><a href="javascript:void(0)" style="background-image: url(<?php echo Yii::app()->params['styleAdmin']; ?>/img/gCons/configuration.png)">Settings</a></li>
            <li><a href="javascript:void(0)" style="background-image: url(<?php echo Yii::app()->params['styleAdmin']; ?>/img/gCons/lab.png)">Lab</a>
            <li><a href="javascript:void(0)" style="background-image: url(<?php echo Yii::app()->params['styleAdmin']; ?>/img/gCons/van.png)"><span class="label label-success">$2851</span> Delivery</a></li>
            <li><a href="javascript:void(0)" style="background-image: url(<?php echo Yii::app()->params['styleAdmin']; ?>/img/gCons/pie-chart.png)">Charts</a></li>
            <li><a href="javascript:void(0)" style="background-image: url(<?php echo Yii::app()->params['styleAdmin']; ?>/img/gCons/edit.png)">Add New Article</a></li>
            <li><a href="javascript:void(0)" style="background-image: url(<?php echo Yii::app()->params['styleAdmin']; ?>/img/gCons/add-item.png)"> Add New Page</a></li>
            <li><a href="javascript:void(0)" style="background-image: url(<?php echo Yii::app()->params['styleAdmin']; ?>/img/gCons/chat-.png)"><span class="label label-important">26</span> Comments</a></li>
        </ul>
    </div>
</div>
<div class="row-fluid">
            ...
            <ul>
                ...
                <li class="thumbnail">
                    <a title="Image_5 title long title long title long" href="gallery/Image05.jpg">
                        <img alt="" src="<?php echo Yii::app()->params['styleAdmin']; ?>/gallery/Image05_tn.jpg">
                    </a>
                    <p>
                ...
                <li class="thumbnail">
                    <a title="Image_6 title long title long title long" href="gallery/Image06.jpg">
                        <img alt="" src="<?php echo Yii::app()->params['styleAdmin']; ?>/gallery/Image06_tn.jpg">
                    </a>
                    <p>
                ...
                <li class="thumbnail">
                    <a title="Image_7 title long title long title long" href="gallery/Image07.jpg">
                        <img alt="" src="<?php echo Yii::app()->params['styleAdmin']; ?>/gallery/Image07_tn.jpg">
                    </a>
                    <p>
                ...
                <li class="thumbnail">
                    <a title="Image_8 title long title long title long" href="gallery/Image08.jpg">
                        <img alt="" src="<?php echo Yii::app()->params['styleAdmin']; ?>/gallery/Image08_tn.jpg">
                    </a>
                    <p>
                ...
                <li class="thumbnail">
                    <a title="Image_9 title long title long title long" href="gallery/Image09.jpg">
                        <img alt="" src="<?php echo Yii::app()->params['styleAdmin']; ?>/gallery/Image09_tn.jpg">
                    </a>
                    <p>
                ...
                <li class="thumbnail">
                    <a title="Image_10 title long title long title long" href="gallery/Image10.jpg">
                        <img alt="" src="<?php echo Yii::app()->params['styleAdmin']; ?>/gallery/Image10_tn.jpg">
                    </a>
                    <p>
                ...
                <li class="thumbnail">
                    <a title="Image_11 title long title long title long" href="gallery/Image11.jpg">
                        <img alt="" src="<?php echo Yii::app()->params['styleAdmin']; ?>/gallery/Image11_tn.jpg">
                    </a>
                    <p>
                ...
                <li class="thumbnail">
                    <a title="Image_12 title long title long title long" href="gallery/Image12.jpg">
                        <img alt="" src="<?php echo Yii::app()->params['styleAdmin']; ?>/gallery/Image12_tn.jpg">
                    </a>
                    <p>
                ...
                <li class="thumbnail">
                    <a title="Image_13 title long title long title long" href="gallery/Image13.jpg">
                        <img alt="" src="<?php echo Yii::app()->params['styleAdmin']; ?>/gallery/Image13_tn.jpg">
                    </a>
                    <p>
                ...
                <li class="thumbnail">
                    <a title="Image_14 title long title long title long" href="gallery/Image14.jpg">
                        <img alt="" src="<?php echo Yii::app()->params['styleAdmin']; ?>/gallery/Image14_tn.jpg">
                    </a>
                    <p>
                ...
                <li class="thumbnail">
                    <a title="Image_15 title long title long title long" href="gallery/Image15.jpg">
                        <img alt="" src="<?php echo Yii::app()->params['styleAdmin']; ?>/gallery/Image15_tn.jpg">
                    </a>
                    <p>
